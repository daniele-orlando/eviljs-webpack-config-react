...
export function createWebpackConfig(options?: undefined | WebpackConfigOptions) {
    ...
    return {
            ...
            rules: [
                ...
                },
                {
                    ...
                    use: [
                        ...
                        //     options: {
                        //         name: 'style-[name]_[contenthash].[ext]',
                        //     },
                        // },
                        {
        ...
        plugins: [
            ...
            new WebpackPluginMiniCssExtract({
                ...
                chunkFilename: Path.join(bundleName, 'style-[id].css'),
                ignoreOrder: true,
            }),
